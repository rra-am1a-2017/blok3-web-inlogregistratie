<?php
  ...
  if ( isset($_GET["status"])) {
    ...
    $white_list = array("emailempty", "emailexists", "nocheck", "success", "createpassword", "activate_success", "activate_empty", "nomatchpassword", "registerform", "loginform", "emptyfields", "accessdenied");
